...
df = pd.read_excel('C:\\Users\\David\\Downloads\\Phase 3\\foundationtbl.xlsx')
...
plt.text(-1, -60,f'The foundation phase took {hours} hours or {weeks} weeks')
plt.text(-1, -47,f'{foundation_linear_ft} linear ft of foundation was done in {weeks} weeks, wich means an average of {lf_week}ft per week')
plt.show()
