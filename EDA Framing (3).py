...
plt.text(-1, -40,f'The framing phase took {hours} hours and {weeks} weeks')
plt.text(-1, -47,f'{sqf_total}sqf where framed in {weeks} weeks, wich means an average of {sqf_week}sqf was framed per week')
plt.show()
...
plt.ylabel('')
plt.text(0, -1.2,'Most of the time there were 2 workers completing this task',fontsize=12, ha='center')
